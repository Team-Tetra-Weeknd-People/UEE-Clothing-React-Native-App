        ...
        <>
            <View style={styles.container}>
                ...
                <View style={styles.tableHeader}>
                    <Text style={styles.manufacturerHeader}>SELLER</Text>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <TouchableOpacity style={styles.tableRow} onPress={() => {
                            navigation.navigate('ReceivedOrderCheckList', { order: item });
                        }}>
                            <Text style={styles.manufacturerCell}>{item.seller.companyName}</Text>
