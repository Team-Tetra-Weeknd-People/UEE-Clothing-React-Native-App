...
export default function MarkAsDefect({ route }) {
    ...
    const onRefresh = useCallback(() => {
        setRefreshing(true);
        MaterialQAComplaintsService.getMaterialQAComplaintByQA(qualityAttributeId)
            .then((res) => {
    ...
    const uploadImage = async () => {
        ...
        try {
            ...
            const data = {
                ...
                materialID: qulaityAttributeDetails.materialID
            };

            if (complaint == null) {
                MaterialQAComplaintsService.updateMaterialQAComplaint(complaint._id, data)
                    .then((res) => {
                ...
                console.log('else ----------------------------------');
                console.log(data);
                MaterialQAComplaintsService.createMaterialQAComplaint(data).then((res) => {
                    MaterialQAService.updateMaterialQA(qualityAttributeId, {
                        status: 'Defect',
                    }).then((res) => {
                        alert('Complaint Created Successfully');
                        // navgiation.navigate('PlacedOrderCheckList', { orderId: orderId });
                        navgiation.navigate('PlacedOrderList');
                    }
                    ).catch((error) => {
