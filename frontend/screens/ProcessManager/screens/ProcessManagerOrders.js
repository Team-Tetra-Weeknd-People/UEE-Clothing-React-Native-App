...
import MaterialOrderAndCheckList from './OrderScreens/MaterialOrderAndCheckList';
...
const ProcessManagerOrders = () => {
    return (
        ...
        >
            ...
            <Stack.Screen name="MaterialOrderDetails" component={MaterialOrderAndCheckList} />
