...
export default function SupplierProfile() {
    ...
    const saveChanges = () => {
        ...
        SupplierService.updateSupplier(supplier._id, data).then((response) => {
            setSupplier(response.data);
            toggleEditing();
        });
    };
                    ...
                    <View style={styles.infoContainer}>
                        <View style={styles.infoRow}>
                            ...
                            {isEditing ? (
                                ...
                                <Text style={styles.value}>{supplier.fname}</Text>
                            )}
                        </View>
                        <View style={styles.infoRow}>
                            ...
                            {isEditing ? (
                                ...
                                <Text style={styles.value}>{supplier.lname}</Text>
                            )}
                        </View>
                        <View style={styles.infoRow}>
                            ...
                            {isEditing ? (
                                ...
                                <Text style={styles.value}>{supplier.companyName}</Text>
                            )}
                        </View>
                        <View style={styles.infoRow}>
